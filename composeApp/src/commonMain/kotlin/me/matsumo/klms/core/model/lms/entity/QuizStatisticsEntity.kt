...
data class QuizStatisticsEntity(
    ...
    val questionStatistics: List<me.matsumo.klms.core.model.lms.entity.QuizStatisticsQuestionStatisticsEntity>?,
    //  Submission-specific statistics
    @SerialName("submission_statistics")
    val submissionStatistics: me.matsumo.klms.core.model.lms.entity.QuizStatisticsSubmissionStatisticsEntity?,
    // Links to related media (JSON-API format)
    @SerialName("links")
    val links: me.matsumo.klms.core.model.lms.entity.QuizStatisticsLinksEntity?,
)
