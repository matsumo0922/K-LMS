...
data class MediaObjectEntity(
    ...
    val mediaTracks: List<me.matsumo.klms.core.model.lms.entity.MediaObjectEntity.MediaTrack>,

    // an array of all the transcoded files ...
    @SerialName("media_sources")
    val mediaSources: List<me.matsumo.klms.core.model.lms.entity.MediaObjectEntity.MediaSource>
) {
    @Serializable
    data class MediaTrack(
        // kind of track: captions or subtitles
        @SerialName("kind")
        val kind: String,
