...
data class AssignmentEntity(
    ...
    @SerialName("external_tool_tag_attributes") val externalToolTagAttributes: ExternalToolTagAttributesEntity?,
    ...
    @SerialName("turnitin_settings") val turnitinSettings: TurnitinSettingsEntity?,
    ...
    @SerialName("overrides") val overrides: List<AssignmentOverrideEntity>?,
    // Information for the user about the lock
    @SerialName("lock_info") val lockInfo: LockInfoEntity?,
    // (Optional) the DiscussionTopic associated with the assignment, if applicable
    @SerialName("discussion_topic") val discussionTopic: DiscussionTopicEntity?,
    ...
    @SerialName("score_statistics") val scoreStatistics: ScoreStatisticEntity?,
